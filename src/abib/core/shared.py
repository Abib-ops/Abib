...
current_directory: Path = package_directory / "data"
...
icon_path: Path = images_dir / "abib_icon0.ico"
if not icon_path.is_file():
    # Fallback to images in package_directory if needed, but we moved it to src/abib/images
    pass
...
bibledict: dict[str, int] = {
        'genesis': 1, 'ge': 1, 'gen': 1, 'gene': 1, 'gn': 1,
        'exodus': 2, 'ex': 2, 'exo': 2, 'exod': 2,
        'leviticus': 3, 'le': 3, 'lev': 3, 'levi': 3, 'levt': 3, 'levtics': 3, "lv": 3, 'levit': 3,
        'numbers': 4, 'nu': 4, 'num': 4, 'number': 4, 'numb': 4, "nm": 4,
        'deuteronomy': 5, 'de': 5, 'deut': 5, 'deu': 5, "dt": 5, 'deuter': 5,
        'joshua': 6, 'jos': 6, 'josh': 6, 'josue': 6,
        'judges': 7, 'jdg': 7, 'judg': 7, 'judge': 7, "jg": 7, "jdj": 7,
        'ruth': 8, 'ru': 8, 'rut': 8,
        '1samuel': 9, '1s': 9, '1sa': 9, '1sam': 9, '1bk': 9, 'ibk': 9,
        'isamuel': 9, 'isam': 9,
        '2samuel': 10, '2s': 10, '2sa': 10, '2sam': 10, '2bk': 10, 'iibk': 10,
        'iisamuel': 10, 'iis': 10, 'iisa': 10, 'iisam': 10,
        '1kings': 11, '1k': 11, '1ki': 11, '1kin': 11, '1king': 11, '3bk': 11, '1kgs': 11, 'kgs': 11,
        'ikings': 11, 'ik': 11, 'iki': 11, 'ikin': 11, 'iking': 11, 'iiibk': 11, 'iiikings': 11,
        '2kings': 12, '2k': 12, '2ki': 12, '2kin': 12, '2king': 12, '4bk': 12, '2kgs': 12,
        ...
        'ezra': 15, 'ezr': 15, 'ez': 15, 'esdr': 15,
        'nehemiah': 16, 'ne': 16, 'neh': 16, 'nehe': 16, 'neem': 16,
        'esther': 17, 'es': 17, 'est': 17, 'esth': 17, 'esthe': 17, 'esta': 17,
        'job': 18, 'jb': 18,
        'psalms': 19, 'psalm': 19, 'psal': 19, 'ps': 19, 'psa': 19, "pss": 19, "psm": 19,
        'proverbs': 20, 'pr': 20, 'pro': 20, 'prov': 20, 'proverb': 20, "prv": 20,
        'ecclesiastes': 21, 'ec': 21, 'ecc': 21, 'eccl': 21, 'ecl': 21, 'eccles': 21, "qoh": 21,"qoheleth": 21,
        'songofsolomon': 22, 'songofsongs': 22, 'so': 22, 'son': 22, 'song': 22,
        'sos': 22, 'songs': 22, 'ss': 22, 'ca': 22, 'canticles': 22, 'sng': 22, 'cant': 22,
        'isaiah': 23, 'isai': 23, 'esaias': 23, 'is': 23, 'isa': 23, 'ish': 23,
        'jeremiah': 24, 'je': 24, 'jer': 24, 'jeremy': 24, 'jeremias': 24,
        'lamentations': 25, 'la': 25, 'lam': 25, 'lamentation': 25, 'lame': 25,
        'ezekiel': 26, 'eze': 26, 'ezek': 26, 'ezk': 26, 'zek': 26, 'ezechiel': 26, 'ezech': 26,
        'daniel': 27, 'da': 27, 'dan': 27, 'dani': 27, "dn": 27,
        'hosea': 28, 'ho': 28, 'hos': 28, 'hose': 28, 'osee': 28,
        'joel': 29, 'joe': 29, 'jol': 29, "jl": 29,
        'amos': 30, 'am': 30, 'amo': 30,
        'obadiah': 31, 'ob': 31, 'oba': 31, 'obad': 31, 'abdias': 31, 'abd': 31,
        'jonah': 32, 'jon': 32, 'jona': 32, 'jonas': 32, 'ion': 32,
        'micah': 33, 'mi': 33, 'mic': 33, 'mica': 33, 'micheas': 33,
        'nahum': 34, 'na': 34, 'nah': 34, 'nam': 34,
        'habakkuk': 35, 'hab': 35, 'haba': 35, 'habak': 35, 'ha': 35, 'hb': 35, "hk": 35,
        'zephaniah': 36, 'zp': 36, 'zep': 36, 'zeph': 36, 'ze': 36, 'sophonias': 36,
        'haggai': 37, 'hag': 37, 'hagg': 37, 'hg': 37, 'haggi': 37, 'aggeus': 37,
        'zechariah': 38, 'zc': 38, 'zec': 38, 'zech': 38, 'zacharias': 38, 'zach': 38,
        'malachi': 39, 'mal': 39, 'mala': 39, 'malac': 39, 'ma': 39, 'malachias': 39,
        'matthew': 40, 'mt': 40, 'mat': 40, 'matt': 40, 'matth': 40,
        'mark': 41, 'mr': 41, 'mk': 41, 'mar': 41, 'mrk': 41, 'marc': 41,
        'luke': 42, 'lu': 42, 'lk': 42, 'luk': 42, 'luc': 42,
        'john': 43, 'joh': 43, 'jn': 43, 'jno': 43, 'jhn': 43, 'jh': 43, 'jo': 43, 'io': 43,
        'acts': 44, 'ac': 44, 'act': 44, 'acta': 44,
        'romans': 45, 'ro': 45, 'rom': 45, 'roman': 45, 'roma': 45, "rm": 45,
        '1corinthians': 46, '1co': 46, '1cor': 46, '1corinthian': 46, '1corinth': 46,
        ...
        'galatians': 48, 'ga': 48, 'gal': 48, 'galatian': 48, 'gala': 48, "gl": 48,
        'ephesians': 49, 'ep': 49, 'eph': 49, 'ephesian': 49, 'ephe': 49, 'ephes': 49,
        'philippians': 50, 'php': 50, 'philip': 50, 'phil': 50, 'ph': 50, 'phili': 50,
        'colossians': 51, 'co': 51, 'col': 51, 'colossian': 51, 'colos': 51, 'coloss': 51, "cl": 51,
        ...
        '2timothy': 55, '2ti': 55, '2tim': 55, "2tm": 55,
        'iitimothy': 55, 'iiti': 55, 'iitim': 55,
        'titus': 56, 'ti': 56, 'tit': 56,
        'philemon': 57, 'phm': 57, 'phi': 57, 'phl': 57, 'phile': 57, 'philo': 57, "phlm": 57, "pm": 57,
        'philem': 57, 'philm': 57,
        'hebrews': 58, 'he': 58, 'heb': 58, 'hebrew': 58, 'hebr': 58,
        'james': 59, 'ja': 59, 'jas': 59, 'jam': 59, 'jame': 59, 'jac': 59,
        '1peter': 60, '1p': 60, '1pe': 60, '1pet': 60, '1pete': 60, "1pt": 60,
        'ipeter': 60, 'ip': 60, 'ipe': 60, 'ipet': 60, 'ipete': 60,
        '2peter': 61, '2p': 61, '2pe': 61, '2pet': 61, '2pete': 61, "2pt": 61,
        ...
        'jude': 65, 'jd': 65, 'jde': 65, "jud": 65, "iud": 65,
        'revelation': 66, 'revelationofjohn': 66, 're': 66, 'rev': 66, 'theapocalypseofjohn': 66, "rv": 66,
