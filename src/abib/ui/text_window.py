...
class TextDocumentWindow(QDialog):
    ...
    def __init__(self, initial_file_path: str | None = None,
        ...
        if settings_service is not None:
            ...
            self.settings_service: SettingsService = SettingsService(filename=str(Path(settings_path).name))
        else:
        ...
        x8, y8, width8, height8 = self.settings_service.get_window_geometry("reader_window")
    ...
    class _ReaderFindDialog(QDialog):
        def __init__(self, parent: "TextDocumentWindow") -> None:
            ...
            try:
                gx, gy, gw, gh = self._parent.settings_service.get_window_geometry("reader_find_window")
        ...
        def closeEvent(self, event):
            ...
            try:
                ...
                self._parent.settings_service.save_window_geometry(
                    "reader_find_window",
                    geometry.x(),
                    geometry.y(),
                    geometry.width(),
